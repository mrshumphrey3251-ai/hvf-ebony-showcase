...
3.  **Simulate and Learn:** Under the **🟡 SIMULATION & TRAINING SANDBOX**, drop the signal integrity dial to simulate a GPS jamming event and watch me shift the fleet to Dead Reckoning.
4.  **Take Command:** Scroll to the **🔴 LIVE EXECUTION (BARE-METAL)** section. Click **🔴 HALT** to instantly lock the fleet's brakes and anchor the chassis.