...
1.  **Simulate and Learn:** Under the **🟡 SIMULATION & TRAINING SANDBOX**, simulate a handoff delay to watch Ebony kill the engine.
2.  **Take Command:** Under **🔴 LIVE EXECUTION**, click **🔴 HALT** to force a cryptographic reset across the fleet.