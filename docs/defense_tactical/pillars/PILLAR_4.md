...
| :--- | :--- | :--- | :--- |
| **Seismic Vibration** | Subterranean Geophones | > 4.2 Richter eq. | Drone Swarm Scramble |
| **Capacitance** | Perimeter Fence Relays | < 2.0V Voltage Drop | Kinetic Override / Alarm |
| **Acoustic** | Triangulated Mics | Decibel spike | Auto-Log to SQLite Vault |
...
1. Physically wire the new sensor node to the localized PoE switch.
2. Authenticate the node via the Executive PIN in the Master Console.
3. Verify the node appears in the telemetry SQLite table.
