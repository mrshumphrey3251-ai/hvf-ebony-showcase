...
Write-Host "[*] Techno Exponent: Connect Flutter UI to http://127.0.0.1:8080" -ForegroundColor Yellow

# Launch the sanitized API Gateway
uvicorn api_gateway.main:app --host 127.0.0.1 --port 8080 --reload
